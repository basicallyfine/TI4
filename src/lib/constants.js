...
const FACTIONS = [
    { code: '0', name: 'The Arborec', sort: 'arborec' },
    { code: '1', name: 'The Argent Flight', pok: true, sort: 'argent' },
    { code: '2', name: 'The Barony of Letnev', sort: 'barony' },
    { code: '3', name: 'The Clan of Saar', sort: 'clan' },
    { code: '4', name: 'The Embers of Muaat', sort: 'embers' },
    { code: '5', name: 'The Emirates of Hacan', sort: 'emirates' },
    { code: '6', name: 'The Empyrean', pok: true, sort: 'empyrean' },
    { code: '7', name: 'The Federation of Sol', sort: 'federation' },
    { code: '8', name: 'The Ghosts of Creuss', sort: 'ghosts' },
    { code: '9', name: 'The L1Z1X Mindnet', sort: 'l1z1x' },
    { code: 'A', name: 'The Mahact Gene-Sorcerers', pok: true, sort: 'mahact' },
    { code: 'B', name: 'The Mentak Coalition', sort: 'mentak' },
    { code: 'C', name: 'The Naalu Collective', sort: 'naalu' },
    { code: 'D', name: 'The Naaz-Rokha Alliance', pok: true, sort: 'naaz-rokha' },
    { code: 'E', name: 'The Nekro Virus', sort: 'nekro' },
    { code: 'F', name: 'The Nomad', pok: true, sort: 'nomad' },
    { code: 'G', name: 'Sardakk N’orr', sort: 'sardakk' },
    { code: 'H', name: 'The Titans of Ul', pok: true, sort: 'titans' },
    { code: 'I', name: 'The Universities of Jol-Nar', sort: 'universities' },
    { code: 'J', name: 'The Vuil’Raith Cabal', pok: true, sort: 'vuilraith' },
    { code: 'K', name: 'The Winnu', sort: 'winnu' },
    { code: 'L', name: 'The Xxcha Kingdom', sort: 'xxcha' },
    { code: 'M', name: 'The Yin Brotherhood', sort: 'yin' },
    { code: 'N', name: 'The Yssaril Tribes', sort: 'yssaril' },
];
