...
const FACTIONS = [
    { code: 'ARB', name: 'The Arborec' },
    { code: 'ARG', name: 'The Argent Flight', pok: true },
    { code: 'BAR', name: 'The Barony of Letnev' },
    { code: 'CLA', name: 'The Clan of Saar' },
    { code: 'EMB', name: 'The Embers of Muaat' },
    { code: 'EMI', name: 'The Emirates of Hacan' },
    { code: 'EMP', name: 'The Empyrean', pok: true },
    { code: 'FED', name: 'The Federation of Sol' },
    { code: 'GHO', name: 'The Ghosts of Creuss' },
    { code: 'L1Z', name: 'The L1Z1X Mindnet' },
    { code: 'MAH', name: 'The Mahact Gene-Sorcerers', pok: true },
    { code: 'MEN', name: 'The Mentak Coalition' },
    { code: 'NAL', name: 'The Naalu Collective' },
    { code: 'NAZ', name: 'The Naaz-Rokha Alliance', pok: true },
    { code: 'NEK', name: 'The Nekro Virus' },
    { code: 'NOM', name: 'The Nomad', pok: true },
    { code: 'SAR', name: 'Sardakk N’orr' },
    { code: 'TIT', name: 'The Titans of Ul', pok: true },
    { code: 'UNI', name: 'The Universities of Jol-Nar' },
    { code: 'VUI', name: 'The Vuil’Raith Cabal', pok: true },
    { code: 'WIN', name: 'The Winnu' },
    { code: 'XCH', name: 'The Xxcha Kingdom' },
    { code: 'YIN', name: 'The Yin Brotherhood' },
    { code: 'YSS', name: 'The Yssaril Tribes' },
];
